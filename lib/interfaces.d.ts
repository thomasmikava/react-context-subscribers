...
export interface ContextSelectorMiniHook<Data extends readonly any[]> {
    ...
    <T>(fn: (...rootData: Data) => T, areDataEqual: (prevValue: T, newValue: T) => boolean, deps?: DependencyList | null, label?: string): T;
}
export interface ContextSelectorHook<Data extends readonly any[]> extends ContextSelectorMiniHook<Data> {
    extendHook<T extends readonly any[]>(fn: (...rootData: Data) => T): ContextSelectorHook<T>;
...
export declare type SubscribeFn<Data extends readonly any[]> = (fn: (...data: Data) => void, label?: string) => Unsubscribe;
